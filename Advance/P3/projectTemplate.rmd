...
grid.newpage()  ###新建图表版面
pushViewport(viewport(layout = grid.layout(3,4))) ####将版面分成n*m矩阵
...
### Description One
#### 从数据集来看，白葡萄酒的品质呈正太分布，大部分的品质都在5～7分。白葡萄酒的剩余糖份含量都偏低，酒精度数基本上都小于14%，平均度数在10.51%。pH值大部分在3～3.5之间，呈正态分布。
